...
Usage:
    uv run python 09-concurrency-scheduling/bot.py            # CLI
    uv run python 09-concurrency-scheduling/bot.py --http     # CLI + HTTP
    uv run python 09-concurrency-scheduling/bot.py --telegram # Telegram + HTTP
"""
import json
import os
import re
...
TOOLS = [
    ...
    {"type": "function", "function": {"name": "save_memory", "description": "Save an important fact to long-term memory.",
        "parameters": {"type": "object", "properties": {
            "topic": {"type": "string", "description": "Topic/category for the memory"},
            "content": {"type": "string", "description": "The information to remember"},
        }, "required": ["topic", "content"]}}},
    {"type": "function", "function": {"name": "memory_search", "description": "Search long-term memory for previously saved knowledge.",
...
def main():
    print("Starting OpenClaw 09 — concurrency + scheduling")
